...
- `0521T001`: `5-21-day-control-60min` live test collection is `待验收`.
...
1. `0521T001` has finished collection and alignment work and is waiting for QA after `0520T002` QA passed.
