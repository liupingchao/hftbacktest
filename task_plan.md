...
- `0820T001 /
  ...
  is the current unique formal task and is `执行中` after first-round
  independent QA returned `未通过` with `P0/P1/P2/P3=0/4/1/0`.
...
- No v2 research stage is executing. `0820T001` is in a bounded repair for
