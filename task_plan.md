...
- No current prepared follow-up is authorized by `0617T006` QA alone. Any execution / live follow-up still needs its own explicit dispatch, prerequisites, QA, and controller approval boundaries.
