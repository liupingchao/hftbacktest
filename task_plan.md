...
- No current prepared follow-up is authorized by `0617T007` QA because the accepted gate decision is `allow_create_0617T008=false`. Any execution / live follow-up still needs repaired prerequisites, a new passing final gate, explicit dispatch, prerequisites, QA, and controller approval boundaries.
