...
- coarsened_needs_more_clean_fills_bucket_count: `335`
- coarsened_reject_quality_negative_bucket_count: `677`
- coarsened_not_decisionable_bucket_count: `0`

Churn sensitivity:
- stage9k_original_hard_gate: ready=0, needs_more=75, reject=252, shape_candidates=0
- recent_reject_throttle_warning: ready=0, needs_more=205, reject=122, shape_candidates=0
- fast_cancel_cancel_readd_warning: ready=0, needs_more=165, reject=162, shape_candidates=0
- non_true_reject_churn_warning: ready=0, needs_more=295, reject=32, shape_candidates=0
