...
- needs_more_clean_fills_bucket_count: `75`
- reject_quality_negative_bucket_count: `252`
...
- 5-31-stage9m-cleanfill-control-120min-a: status=usable, caveated=False, rows=5742, notes=none
