...
- `0528T002` has been created to implement the first `0527T001` QA recommendation. It should fix the replay audit bloat by producing a formal compact lifecycle audit or writer-side terminal-order de-dup for Stage 6 input, while preserving full forensic audit only as optional evidence and avoiding strategy/live/fill-cancel semantic/promotion changes.
