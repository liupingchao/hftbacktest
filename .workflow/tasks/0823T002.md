...
- control_remediation_plan_sha256=c1d78dbdd00adf34a06973dd8e7d4b5e759c5ad1b07bd2f4a2618d0e909658a7
- round5_candidate_commit=72257a3b5a4c7ca91b6616ac64bee0784aa94164
- round5_candidate_receipt_sha256=adc8c904ab5ae26ac43e94d487cab5e04418b975034dfd8de9689de782ca4285
- round5_review_commit=848af12895736fac84ad0a71a5167bc3c2b3e4ef
- round5_review_sha256=fcb6657e380bc74e156f380063a4df379a551f484606ed33f018ac12eaa7c4df
- round5_final_severity=P0/P1/P2/P3=0/1/0/0
- control_candidate_commit=180572c669b4d1259eb26b9d268fa6335c0780a1
- control_candidate_receipt_path=.workflow/reports/0823T002-v4-candidate-receipt-round6.json
- control_candidate_receipt_sha256=246d4dfd3caca72b1db9cdff2070bd3fafcd41a8531cc1da4c8ce30c6a0df659
- control_candidate_receipt_commit=a394c7f2d84b817227966627b45b573b397d2198
- control_remediation_review_path=.workflow/reports/0823T002-plan-v4-review.md
- control_remediation_review_sha256=d98d11b7aa5ea4bb29c0f01a738601d8f1b27f842516eb024bede8a8080e0771
- control_review_submission_path=.workflow/reports/0823T002-plan-v4-review-submission.md
- control_review_submission_sha256=bab1c75c2083a93f6a912ec917887a2282e52d24bedcacf692741c18592a81e9
- control_review_commit=2a87677f3079f0565a573245606dde825ea732cd
- controller_actor_id=codex-main-controller
- reviewer_actor_id=codex-independent-reviewer-0823T002-v4-round6-180572c6
- control_final_severity=P0/P1/P2/P3=0/0/0/0
- execution_authority_commit=71adbfa678ff3646982160d220f5c223e0f7e59f
- execution_authority_tree_oid=4c15ab4f613178e1e9468db600885f091244aadc
...
- workflow_transition_receipt_sha256=fcb39e1021689c45b9014dfe599de853465635c8fb2ac7640e19e1bbb073739e
...
- surface_matrix_sha256=8255d49917eaf0abedc62f74ef9609dfc1ccac9fea4e98abbcc764445ccee25d
- hostile_target_contract_path=.workflow/contracts/0823T002-hostile-target-contract.json
- hostile_target_contract_sha256=67e1977b6d29a07f86e6542eb5c2a8a8fc70fc4e42fc1f296213c123f2e6ba72
- qa_round2_handoff_commit=60425952598100c2e59fde6997b5287aac8f611e
- qa_round2_report_path=.workflow/reports/0823T002-qa.md
- qa_round2_report_sha256=65e9ebb091aae5f7b7ce198ae49ac8e11a9f62e11813cd088de365b884df8b22
- qa_round2_report_commit=7191442197b37545d3e9847ac0da98d51524421b
- qa_round2_reviewer_actor_id=codex-independent-qa-reviewer-0823T002-round2-60425952
- qa_round2_final_severity=P0/P1/P2/P3=0/0/0/0
...
- expected_runtime_source_tree_sha256=800fb6380a5117139ccde27f1b1212f0e624ff2ea7fe2565861be6cd5bc54a1d
...
QA验收方式：
- V4 Round 6 exact handoff revision `60425952` 已由独立 QA Round 2
  以 `P0/P1/P2/P3=0/0/0/0` 验收通过。

QA验收线程动作：
- 独立只读验收 immutable formal authority、V4 control/handoff chain、
  89+89 hostile evidence、42-file Git-object binding 和 package
  zero-write admission；不重跑 outcome。
...
- The accepted generic Trust Kernel negative-evidence validator is necessary
  ...
  current/frozen runtime tree, complete ordered 89-mutation code/target
  contracts and
  `fail_open_count=0`.
...
6. Execute all 89 current/frozen hostile mutations; require fail-open count 0.
...
- business report ends at `待验收`; independent QA Round 2 accepted the
  immutable authority, transition receipt and final-state hostile/Gate 0
  evidence at `P0/P1/P2/P3=0/0/0/0`.
- task terminal status is `已通过`; the formal execution entrypoint remains
  closed and no final signal claim is added.
...
| `execution_authority` | `mutate_execution_authority_task` -> `H0B_EXECUTION_AUTHORITY_MISMATCH`<br>`mutate_execution_authority_commit` -> `H0B_EXECUTION_AUTHORITY_MISMATCH`<br>`mutate_execution_authority_package_object` -> `H0B_EXECUTION_AUTHORITY_MISMATCH`<br>`mutate_frozen_git_object_store` -> `H0B_EXECUTION_AUTHORITY_MISMATCH` | 1 | `C` |
| `formal_attempt_protocol` | `mutate_formal_attempt_reuse` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_staging_reuse` -> `PUBLICATION_STAGING_EXISTS`<br>`mutate_formal_attempt_missing_receipt` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_partial_hard_stop_recovery` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_torn_receipt` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_attempts_root_escape` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_bootstrap_recovery` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_subcommand_without_attempt` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_attempts_parent_fsync` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_concurrent_claim` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_bootstrap_receipt_cross_binding` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_attempts_root_symlink` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH`<br>`mutate_formal_attempts_parent_symlink` -> `H0B_FORMAL_ATTEMPT_STATE_MISMATCH` | 1 | `C` |
| `independent_review_provenance` | `mutate_review_same_actor` -> `H0B_REVIEW_PROVENANCE_MISMATCH`<br>`mutate_review_candidate_commit` -> `H0B_REVIEW_PROVENANCE_MISMATCH`<br>`mutate_review_post_introduction_rewrite` -> `H0B_REVIEW_PROVENANCE_MISMATCH`<br>`mutate_review_receipt_chronology` -> `H0B_REVIEW_PROVENANCE_MISMATCH`<br>`mutate_review_commit_scope` -> `H0B_REVIEW_PROVENANCE_MISMATCH` | 16 | `C` |
