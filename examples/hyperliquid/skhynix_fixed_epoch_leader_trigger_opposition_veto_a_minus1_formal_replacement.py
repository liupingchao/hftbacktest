#!/usr/bin/env python3
"""Execute the frozen 0830T003 leader-trigger opposition-veto A-1 audit."""
...
PLAN_PATH = Path(
    ...
    "formal_replacement_execution_plan_20260830.md"
)
TASK_PATH = Path(".workflow/tasks/0830T003.md")
RUNNER_PATH = Path(
    "examples/hyperliquid/"
    "skhynix_fixed_epoch_leader_trigger_opposition_veto_a_minus1_formal_replacement.py"
)
VERIFIER_PATH = Path(
    "examples/hyperliquid/"
...
TEST_PATH = Path(
    "examples/hyperliquid/"
    "test_skhynix_fixed_epoch_leader_trigger_opposition_veto_a_minus1_formal_replacement.py"
)
...
CLAIM_ARMED_PATH = Path(".workflow/attempt-claims/0830T003.armed.json")
CLAIMED_PATH = Path(".workflow/attempt-claims/0830T003.claimed.json")
TERMINAL_RECEIPT_PATH = Path(".workflow/attempt-receipts/0830T003.terminal.json")

IDEA_SHA256 = "a916717f21e1714298520e69f8e2702920f4cd54308f5d554691d4364a1cc997"
PLAN_SHA256 = "a8b26fafe2156b2948c84875f206219184aa8fe17098d28fc322eba05df233a5"
...
CONSUMPTION_TAG = "skhynix-fixed-epoch-leader-trigger-a-minus1-replacement-consumed-v1"
TERMINAL_TAG = "skhynix-fixed-epoch-leader-trigger-a-minus1-replacement-terminal-v1"
CONSUMPTION_MESSAGE = "audit: consume 0830T003 formal attempt claim"
TERMINAL_MESSAGE = "audit: seal 0830T003 formal attempt result"

CONTROLLER_REMOTE = "origin"
CONTROLLER_URL = "git@github.com:liupingchao/hftbacktest.git"
CONTROLLER_REF = "refs/heads/codex/0830T003-controller-ledger"
...
DEFAULT_ATTEMPT_ROOT = Path(
    "local_live_analysis/"
    "skhynix_fixed_epoch_leader_trigger_opposition_veto_"
    "a_minus1_formal_replacement_0830T003_formal_v1"
)
...
def verify_baseline_authority(repo_root: Path) -> dict[str, Any]:
    baseline_manifest = baseline_verifier.load_manifest(repo_root)
    return baseline_verifier.verify_authority(
        repo_root,
        baseline_manifest,
...
def execute_formal_attempt(
    *,
    ...
    verify_baseline_authority(repo_root)
