...
def run_analysis(*, t011_root: Path, t002_dir: Path, t003_dir: Path, output_dir: Path) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "accepted_source_row_count": len(t002_rows),
        "prior_reference_count": counts(attempts, "source_kind").get("prior_accepted_replay_reference", 0),
        "live_artifact_attempt_count": counts(attempts, "source_kind").get("t011_live_window_artifact", 0),
